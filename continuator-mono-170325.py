...
_max_continuation_length = 100			# Maximum number of notes of a continuation
_max_played_notes_considered = 100	 # Maximum last number of played notes considered for training
...
#_default_fixed_duration = 1		int for midiFile (Batch mode)
