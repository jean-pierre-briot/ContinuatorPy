...
class PrefixTreeContinuator:
    ...
    def train(self, sequence):
        ...
        # Construire l'arbre sans ajouter le dernier élément comme n½ud
        for start in range(len(notes) - 1):  # Jusqu'à l'avant-dernier élément
            ...
            for i in range(start, -1, -1):  # Lire la séquence de droite à gauche
                ...
                # Ajouter la continuation (dernier élément de la séquence)
                if start == len(notes) - 2 and notes[-1] not in current_node.continuations:
