...
class PrefixTreeContinuatorRealtime:
    ...
    def generate(self, seed, length=10):
        """Génère une continuation polyphonique avec recherche adaptative du préfixe."""
        ...
        for _ in range(length):
            ...
            while i > 0:
                sub_prefix = tuple(generated_chords[-i:])  # Essayer avec une sous-séquence
                temp_node = self.root
                match_found = True
                ...
                if match_found and temp_node.continuations:
                    ...
                    break  # Trouvé, on arrête la réduction
                i -= 1  # Réduction de la taille du préfixe testé
