...
class PrefixTreeContinuatorRealtime:
    """Continuateur temps réel basé sur des arbres préfixés."""
    def __init__(self, silence_threshold=2.0):
        self.root = PrefixTreeNode()
        self.sequences = []
        self.last_note_time = time.time()
        self.recorded_notes = []
        self.silence_threshold = silence_threshold  # Temps avant génération (en secondes)

    def train(self, sequence):
        """Ajoute une séquence à l'arbre en analysant de droite à gauche."""
    ...
    def generate(self, seed, length=10):
        """Génère une suite de notes en cherchant le plus long préfixe correspondant."""
        generated = list(seed)
    ...
    def play_midi_output(self, port_name, notes, duration=0.3):
        """Joue une séquence MIDI en temps réel."""
