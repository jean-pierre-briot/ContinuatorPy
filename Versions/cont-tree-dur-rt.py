...
class PrefixTreeContinuatorRealtime:
    """Continuateur en temps réel basé sur un arbre préfixé, avec gestion robuste des erreurs."""
    ...
    def generate(self, seed, length=_max_generated_notes):
        """Génère une continuation en cherchant un préfixe valide."""
...
continuator = PrefixTreeContinuatorRealtime(duration_from_learned=_duration_from_learned)  # "input" pour reprendre les durées jouées
