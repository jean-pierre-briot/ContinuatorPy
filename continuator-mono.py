...
_max_continuation_length = 300			    # Maximum number of notes of a continuation
_max_played_notes_considered = 200		    # Maximum last number of played notes considered for training
